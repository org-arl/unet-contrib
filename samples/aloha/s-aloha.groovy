//! Simulation: Slotted Aloha wireless network
///////////////////////////////////////////////////////////////////////////////
///
/// To run simulation:
...
def loadRange = [0.15, 2.0, 0.15]     // min, max, step
    ...
    nodes.each { myAddr ->
      ...
      myNode.startup = {
        ...
        add new PoissonBehavior(1000*nodes.size()/load, {
          // schedule transmission at next time slot
          def t = currentTimeMillis()
          add new WakerBehavior(Math.ceil(t/1000)*1000-t, {   // next time slot
